...
ALTER TABLE "authors" ADD CONSTRAINT "authors_avatar_media_id_media_id_fk" FOREIGN KEY ("avatar_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_tokens" ADD CONSTRAINT "service_tokens_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "articles_site_slug_unique" ON "articles" USING btree ("site_id","slug");--> statement-breakpoint
CREATE UNIQUE INDEX "articles_site_external_key_unique" ON "articles" USING btree ("site_id","external_key");--> statement-breakpoint
CREATE INDEX "articles_site_status_idx" ON "articles" USING btree ("site_id","status");--> statement-breakpoint
...
CREATE UNIQUE INDEX "authors_site_slug_unique" ON "authors" USING btree ("site_id","slug");--> statement-breakpoint
CREATE UNIQUE INDEX "categories_site_slug_unique" ON "categories" USING btree ("site_id","slug");--> statement-breakpoint
CREATE INDEX "categories_site_parent_idx" ON "categories" USING btree ("site_id","parent_id");--> statement-breakpoint
CREATE INDEX "entities_site_type_idx" ON "entities" USING btree ("site_id","type");--> statement-breakpoint
CREATE UNIQUE INDEX "idempotency_keys_scope_key_unique" ON "idempotency_keys" USING btree ("key","actor_key");--> statement-breakpoint
...
CREATE UNIQUE INDEX "redirects_site_source_unique" ON "redirects" USING btree ("site_id","source_path");--> statement-breakpoint
CREATE UNIQUE INDEX "roles_site_key_unique" ON "roles" USING btree (coalesce("site_id", '00000000-0000-0000-0000-000000000000'),"key");--> statement-breakpoint
...
CREATE INDEX "sources_site_name_idx" ON "sources" USING btree ("site_id","name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "webhook_deliveries_hook_event_unique" ON "webhook_deliveries" USING btree ("webhook_id","outbox_event_id");--> statement-breakpoint
